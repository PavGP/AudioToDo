package com.pavgp.audiotodo.fragments;
...
import com.pavgp.audiotodo.Utility.ItemTouchHelperClass;
import com.pavgp.audiotodo.Utility.RecyclerViewEmptySupport;
import com.pavgp.audiotodo.Utility.StoreRetrieveData;
import com.pavgp.audiotodo.Utility.ToDoItem;
import com.pavgp.audiotodo.Utility.TodoNotificationService;
import com.pavgp.audiotodo.activities.AddToDoActivity;
import com.pavgp.audiotodo.activities.CustomRecyclerScrollViewListener;
...
public class TextToDoFragment extends Fragment {
    private RecyclerViewEmptySupport mRecyclerView;
    private FloatingActionButton mAddToDoItemFAB;
    private ArrayList<ToDoItem> mToDoItemsArrayList;
    private CoordinatorLayout mCoordLayout;
    public static final String TODOITEM = "com.pavgp.audiotodo.MainActivity";
    private TextToDoFragment.BasicListAdapter adapter;
    ...
    public static final String SHARED_PREF_DATA_SET_CHANGED = "com.pavgp.datasetchanged";
    public static final String CHANGE_OCCURED = "com.pavgp.changeoccured";
    private int mTheme = -1;
    private String theme = "name_of_the_theme";
    public static final String THEME_PREFERENCES = "com.pavgp.themepref";
    public static final String RECREATE_ACTIVITY = "com.pavgp.recreateactivity";
    public static final String THEME_SAVED = "com.pavgp.savedtheme";
    public static final String DARKTHEME = "com.pavgp.darktheme";
    public static final String LIGHTTHEME = "com.pavgp.lighttheme";
...
//        }
        ...
        adapter = new TextToDoFragment.BasicListAdapter(mToDoItemsArrayList);
        setAlarms();
...
//        makeUpItems(mToDoItemsArrayList, testStrings.length);
        ...
        mCoordLayout = (CoordinatorLayout) recordView.findViewById(R.id.myCoordinatorLayout);
        mAddToDoItemFAB = (FloatingActionButton) recordView.findViewById(R.id.addToDoItemFAB);
...
//        mRecyclerView = (RecyclerView)findViewById(R.id.toDoRecyclerView);
        mRecyclerView = (RecyclerViewEmptySupport) recordView.findViewById(R.id.toDoRecyclerView);
//        if (theme.equals(LIGHTTHEME)) {
...
//            TextDrawable myDrawable = TextDrawable.builder().buildRound(item.getToDoText().substring(0,1),holder.color);
            ...
            if (item.getToDoDate() != null) {
                ...
                if (android.text.format.DateFormat.is24HourFormat(getContext())) {
                    timeToShow = AddToDoFragment.formatDate(TextToDoFragment.DATE_TIME_FORMAT_24_HOUR, item.getToDoDate());
                } else {
                    timeToShow = AddToDoFragment.formatDate(TextToDoFragment.DATE_TIME_FORMAT_12_HOUR, item.getToDoDate());
                }
...
//    @Override
    ...
    public static TextToDoFragment newInstance(int position) {
        TextToDoFragment f = new TextToDoFragment();
        Bundle b = new Bundle();
