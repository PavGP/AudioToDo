...
import com.pavgp.audiotodo.activities.MainActivity;
...
//        app.send(this);
        ...
        theme = getActivity().getSharedPreferences(TextToDoFragment.THEME_PREFERENCES, MODE_PRIVATE).getString(TextToDoFragment.THEME_SAVED, TextToDoFragment.LIGHTTHEME);
//        if (theme.equals(TextToDoFragment.LIGHTTHEME)) {
//            getActivity().setTheme(R.style.CustomStyle_LightTheme);
//        } else {
//            getActivity().setTheme(R.style.CustomStyle_DarkTheme);
//        }
        storeRetrieveData = new StoreRetrieveData(getContext(), TextToDoFragment.FILENAME);
        mToDoItems = TextToDoFragment.getLocallyStoredData(storeRetrieveData);
...
//        i.putExtra(EXIT, true);
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(TextToDoFragment.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
    ...
    private void changeOccurred() {
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(TextToDoFragment.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(TextToDoFragment.CHANGE_OCCURED, true);
//        editor.commit();
        editor.apply();
    }
