...
//        }
        ...
        if (theme.equals(TextToDoFragment.DARKTHEME)) {
...
//            mUserReminderDate = new Date();
            ...
            Log.d("pavgp", "Imagined Date: " + mUserReminderDate);
            String timeString;
            if (time24) {
...
//            mTimeEditText.setText(timeOption);
    ...
    private String getThemeSet() {
        return getActivity().getSharedPreferences(TextToDoFragment.THEME_PREFERENCES, MODE_PRIVATE).getString(TextToDoFragment.THEME_SAVED, TextToDoFragment.LIGHTTHEME);
    }
...
//        mUserToDoItem.setLastEdited(mLastEdited);
        ...
        i.putExtra(TextToDoFragment.TODOITEM, mUserToDoItem);
