...
public class DeleteNotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        storeRetrieveData = new StoreRetrieveData(this, TextToDoFragment.FILENAME);
    ...
    private void dataChanged() {
        SharedPreferences sharedPreferences = getSharedPreferences(TextToDoFragment.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
